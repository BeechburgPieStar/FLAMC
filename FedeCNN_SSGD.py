...
checkpoint = ModelCheckpoint("FedeCNN_SSGD.hdf5", 
                     verbose=1, 
                     save_best_only=True)
tensorboard = TensorBoard("FedeCNN_SSGD.log", 0)
model.load_weights("FedeCNN_SSGD.hdf5" )
...
for snr in snrs:
	...
	subacc = [acc1, acc2,acc3, acc4, acc]
	print(subacc)