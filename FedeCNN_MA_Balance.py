...
def averagemodel(weightpath, model):
	...
	model.save_weights('MA_BalanceFactor.hdf5')
	return model
...
sub_epoch = 1
epochs = int(1/sub_epoch)
batch_size = 1000
start_epoch = -1
weightpath = ['Sub_BalanceFactor1.hdf5','Sub_BalanceFactor2.hdf5','Sub_BalanceFactor3.hdf5','Sub_BalanceFactor4.hdf5']
model = CNN()
loss1 = []
loss2 = []
loss3 = []
...
for epoch in range(epochs):
	...
	if epoch !=start_epoch:
		model.load_weights("MA_Balance.hdf5")
	...
	# SubModel3
	if epoch !=start_epoch:
		model.load_weights("MA_BalanceFactor.hdf5")
